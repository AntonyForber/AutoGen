...
@section('layout-body')
    ...
    <div class="default-view">
        <h1>Генератор crud</h1>

        <p>Этот генератор создает контроллер, представления и другие файлы, которые реализуют операции CRUD (создание, чтение, обновление, удаление) для указанной модели данных.</p>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-10" id="form-fields">
                    <div class="module-form">
                        ...
                        <div class="form-group">
                            {!! Form::label('list_type', 'Вид списка', ['class' => 'control-label']) !!}
                            {!! Form::select('list_type', [
                                'paginate' => 'С пагинацией',
                                'sortable' => 'Сортируемый без пагинации'
                            ], 'paginate' ,['class' => 'form-control']) !!}
                        </div> 
                        
                        <div class="form-group">
                            {!! Form::label('list_attributes', 'Поля для списка', ['class' => 'control-label']) !!}
                            {!! Form::text('list_attributes', null, ['class' => 'form-control']) !!}
                        </div> 
                        ...
                        <div class="form-group">
                            {!! Form::label('route', "Алиас route'a", ['class' => 'control-label']) !!}
