...
namespace AntonyForber\gii\model;
...
/**
 * This generator will generate ActiveRecord class and database table based on the selected settings.
 * @author Antony Forber <forber@mail.ua>
 */
